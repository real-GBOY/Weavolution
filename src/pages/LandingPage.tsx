				...
				<div className='container-custom grid md:grid-cols-2 gap-12 py-20 md:py-0'>
					...
					<motion.div
						...
						<p className='text-xl text-neutral-100 mb-8 max-w-xl'>
							Weavolution is an Enactus Menoufiya initiative tackling the global
							textile waste challenge through innovative recycling and upcycling
							solutions.
						</p>

						{/* Regular buttons (no animation) */}
						<div className='flex flex-wrap gap-4'>
							<button
								type='button'
								onClick={() => navigate("/products")}
								className='btn btn-primary bg-accent-500 hover:bg-accent-600 focus:ring-accent-500'>
								Explore Products
							</button>
							<button
								type='button'
								onClick={() => navigate("/learn-more")}
								className='btn bg-transparent border-2 border-white hover:bg-white/10 text-white focus:ring-white'>
								Learn More
							</button>
						</div>
					</motion.div>
					...
					<div className='grid md:grid-cols-2 gap-8 lg:gap-16 items-center mt-12'>
						<motion.div
							...
							<p className='text-lg text-neutral-700 mb-6'>
								Weavolution was born from a simple observation: the vast amount
								of textile waste generated globally and locally that ends up in
								landfills, despite having significant untapped value.
							</p>
							<p className='text-lg text-neutral-700 mb-6'>
								Our team at Enactus Menoufiya recognized this opportunity and
								developed innovative processes to transform this waste into
								valuable products while creating positive social, economic, and
					...
					<div className='grid md:grid-cols-3 gap-8 mt-12'>
						<motion.div
							...
							<p className='text-neutral-600'>
								...
								annually, with most ending up in landfills.
							</p>
						</motion.div>
						...
						<motion.div
							...
							<p className='text-neutral-600'>
								Only 20% of textiles are recycled globally, leaving vast amounts
								of potential resources untapped.
							</p>
						</motion.div>
						...
						<motion.div
							...
							<p className='text-neutral-600'>
								In Egypt, over 1.2 million tons of textile waste are generated
								annually, with minimal infrastructure for proper recycling.
							</p>
						</motion.div>
					</div>
				</div>
							...
							<div className='space-y-8'>
								<div className='flex gap-4'>
									...
									<div>
										...
										<p className='text-neutral-600'>
											Transforming textile waste into valuable products like 3D
											printing filament, yarn, MDF boards, and furniture.
										</p>
									</div>
								</div>
								...
								<div className='flex gap-4'>
									...
									<div>
										...
										<p className='text-neutral-600'>
											Implementing eco-friendly manufacturing processes that
								...
								<div className='flex gap-4'>
									...
									<div>
										...
										<p className='text-neutral-600'>
											Creating a closed-loop system that extends the lifecycle
											of textile materials indefinitely.
										</p>
									</div>
								</div>
								...
								<div className='flex gap-4'>
									...
									<div>
										...
										<p className='text-neutral-600'>
											Involving local communities through education, collection
					...
					<div className='grid md:grid-cols-2 lg:grid-cols-4 gap-8 mt-12'>
						<motion.div
							...
							<div className='p-5'>
								...
								<p className='text-neutral-600 text-sm mb-4'>
									Sustainable filament made from recycled textile waste for 3D
						...
						<motion.div
							...
							<div className='p-5'>
								...
								<p className='text-neutral-600 text-sm mb-4'>
									High-quality yarn made from recycled textile materials for
						...
						<motion.div
							...
							<div className='p-5'>
								...
								<p className='text-neutral-600 text-sm mb-4'>
									Sustainable MDF boards made from compressed textile waste for
									construction.
								</p>
								<Link
									to='/products/3'
						...
						<motion.div
							...
							<div className='p-5'>
								...
								<p className='text-neutral-600 text-sm mb-4'>
									Beautiful furniture pieces created using recycled textile
									materials.
								</p>
								<Link
									to='/products/4'
				...
				<div className='container-custom'>
					<div className='max-w-4xl mx-auto text-center'>
						...
						<motion.p
							...
							Partner with us, support our initiatives, or simply spread
							awareness about the importance of textile waste reduction.
						</motion.p>
						<motion.div
							initial={{ opacity: 0, y: 20 }}
							whileInView={{ opacity: 1, y: 0 }}
							...
							<Link
								to='/contact'
								className='btn btn-primary bg-accent-500 hover:bg-accent-600'>
								Contact Us
							</Link>
							<Link
								to='/partners'
								className='btn bg-transparent border-2 border-white hover:bg-white/10 text-white'>
								Become a Partner
							</Link>
						</motion.div>
					</div>
